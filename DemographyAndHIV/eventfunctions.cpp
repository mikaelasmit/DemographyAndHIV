...
void EventMyHIVInfection(person *MyPointerToPerson){
	...
	//cout << endl << "Person details: Person ID: " << MyPointerToPerson->PersonID << " Sex: " << MyPointerToPerson->Sex << " Age: " << MyPointerToPerson->Age << " Date HIV: " << MyPointerToPerson->HIV << endl;
	//cout << "H: " << h << " A: " << a << " I: " << i << " J: " << j << " CD4 at start: " << MyPointerToPerson->CD4_cat_start << endl;
...
void EventCD4change(person *MyPointerToPerson){
	...
	//cout << "WARNING: Lets check CD4 count of Patient: " << MyPointerToPerson->PersonID << endl;
	//cout << " CD4 count cat start: " << MyPointerToPerson->CD4_cat_start << " Sex: " << MyPointerToPerson->Sex << " Age: " << MyPointerToPerson->Age << endl;
	//cout << "ARTDEATH Array: " << ARTDeath_event[MyPointerToPerson->Sex-1][i][MyPointerToPerson->CD4_cat] << endl;
	//cout << "I: " << i << " Sex Index: " << MyPointerToPerson->Sex-1 << " CD4 count cat: " << MyPointerToPerson->CD4_cat << endl;
	//system("pause");
